...
*/
    class GestureMenuScreen : MenuScreen
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if (this.is_disabled)
                spriteBatch.Draw(this._imgdisabled, this._hitArea, null, Color.White, 0, Vector2.Zero, SpriteEffects.None, 0.48F);
            else if (!this.is_over)
                spriteBatch.Draw(this._imgoff, this._hitArea, null, Color.White, 0, Vector2.Zero, SpriteEffects.None, 0.48F);
            else if (this.is_over)
            {
                spriteBatch.Draw(this._img, this._hitArea, null, Color.White, 0, Vector2.Zero, SpriteEffects.None, 0.48F);
                spriteBatch.Draw(this._other.Key, this._other.Value, null, Color.White, 0, Vector2.Zero, SpriteEffects.None, 0.50F);
            }
